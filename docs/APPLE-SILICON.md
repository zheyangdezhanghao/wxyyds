...
- build **268853**（4.1.10.53）— Framework 全功能
...
| 最新测试 build | 34371 (offsets) | 269077 (4.1.11) |

> **说明**：本仓库在 CI（macos-latest / arm64 runner）与静态测试中验证 arm64 offsets 与编译链。实机 Patch 请在 M 系列 Mac 上运行 `install.sh --yes` 后登录微信确认稳定。
